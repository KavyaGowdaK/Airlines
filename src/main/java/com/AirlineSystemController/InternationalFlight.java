...
@WebServlet("/InternationalFlightsServlet")
public class InternationalFlight extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/project", "root", "Kavya@123");
            Statement stmt = con.createStatement();
            String sql = "SELECT * FROM flight WHERE flight_type='International' and cast(departure_time as DATE)>= CURDATE()";
